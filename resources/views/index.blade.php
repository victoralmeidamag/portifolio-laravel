    ...
    <main class="main">
        <section class="home" id="home">
            <div class="home__container container grid">
                <div class="home__content">
                    ...
                    <p class="home__description"><strong>Linguagens Web:</strong> Trabalho com PHP e JavaScript, duas das linguagens mais essenciais para o
                        desenvolvimento web. Essas ferramentas me permitem criar aplicações dinâmicas e interativas.<br><br>
                        <strong>Framework Laravel:</strong> Sou proficiente no Laravel, um dos frameworks mais populares para
                        desenvolvimento PHP.<br><br>
                        <strong>Python e Biblioteca Selenium:</strong> Tenho uma breve, porém valiosa, experiência com Python. Utilizo a
                        biblioteca Selenium para automação de testes e tarefas repetitivas.<br><br>
                        <strong>Gerenciamento de Dados:</strong> Minha expertise inclui bancos de dados como PostgreSQL, MySQL, SQLite e
                        MongoDB. Seja modelando esquemas, otimizando consultas ou garantindo a integridade dos dados,
                        estou à vontade com essas tecnologias.
                    </p>
                    <div class="home__btns">
                        <a href="#contact" class="btn">Me Contate</a>
                        <a href="#work" class="btn btn--transparent">Portifólio</a>
                    </div>
                </div>
            ...
            <div class="about__container container grid">
                ...
                <div class="about__content">
                    ...
                    <p class="about__description">
                        Olá! Meu nome é Victor, tenho 24 anos e sou de Bauru-SP. Desde cedo, minha paixão pela
                        tecnologia me levou à programação. Como profissional, evoluí constantemente, buscando aprimorar
                        meus conhecimentos. Acredito que, na área de TI, a aprendizagem contínua é essencial,
                        considerando as inovações diárias.<br>
                    </p>
                    ...
                    <div class="resume__items">
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Ciência da Computação é uma área de conhecimento em exatas focada no desenvolvimento
                                    de programas, ferramentas tecnológicas, dispositivos e metodologias computacionais
                                    com o propósito de informatizar e automatizar processos por meio do processamento de
                                    dados.<br><br><br><br>
                                </p>
                            </div>
                        </div>
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Mais de 17 cursos concluídos, entre eles: Cursos HTML5 e CSS3, do iniciante ao
                                    avançado;<br>
                                    Curso de C#: Criando sua primeira aplicação;<br>
                                    Cursos Python, desde Começando na linguagem, até Entendendo a Orientação a Objetos;
                                    Curso de PHP do básico ao avançado;
                                    Curso de JavaScript do básico ao avançado;
                                    Curso de Laravel do básico ao avançado;
                                </p>
                            </div>
                        </div>
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Conclusão do Ensino Médio.<br><br><br>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="resume__items">
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Como parte da equipe, minha função era criar e aprimorar produtos, seguindo a
                                    metodologia ágil SCRUM. Eu trabalhava com GIT para versionamento, e minhas
                                    ferramentas de escolha eram PHP, Laravel e JavaScript para programação, além de
                                    HTML, CSS e JavaScript para estilização. Além disso, eu tinha a responsabilidade de
                                    gerenciar Bancos de Dados Relacionais como PostgreSQL, MySQL e SQLite, bem como
                                    Bancos de Dados Não Relacionais, como o MongoDB.
                                </p>
                            </div>
                        </div>
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Eu desempenhava o papel de mediador entre os clientes (pessoas) e os clientes
                                    (contratantes), buscando resolver dívidas pendentes de forma amigável e
                                    eficaz.<br><br><br><br><br>
                                </p>
                            </div>
                        </div>
                        <div class="resume__item">
                            ...
                            <div class="resume__content">
                                ...
                                <p class="resume__description">
                                    Eu desempenhava o papel de mediador entre os clientes (pessoas) e os clientes
                                    (contratantes), buscando resolver dívidas pendentes de forma amigável e eficaz.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="work__container container grid">
                <a href="{{ route('filmes') }}" target="_blank">
                    <div class="work__card">
                        <img src="{{ asset('img/filmes.jpeg') }}" alt="" class="work__img">
                ...
                <a href="{{ route('previsao') }}" target="_blank">
                    <div class="work__card">
                        <img src="{{ asset('img/weather.jpeg') }}" alt="" class="work__img">
                        <div class="work__details">
                ...
                <a href="{{ route('flappy') }}" target="_blank">
                    <div class="work__card">
                        <img src="{{ asset('img/flappy.jpeg') }}" alt="" class="work__img">
        ...
        <section class="contact section" id="contact">
            ...
            <div class="contact__container container grid">
                ...
                <form action="{{route('store.contato')}}" class="contact__form" method="post">
                    @csrf
                    <div class="form__group">
                        <div class="form__input">
                            <input type="text" id="de_nome" name="de_nome" placeholder="Nome" class="input__control">
                        </div>
                        <div class="form__input">
                            <input type="email" id="de_email" name="de_email" placeholder="E-mail" class="input__control">
                        </div>
                    </div>
                    <div class="form__input">
                        <input type="text" id="de_assunto" name="de_assunto" placeholder="Assunto" class="input__control">
                    </div>
                    <div class="form__input">
                        <textarea name="message" id="message" placeholder="Mensagem" cols="30" rows="10"
